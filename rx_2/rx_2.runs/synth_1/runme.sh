...
HD_PWD='C:/Users/Chris Nutsukpui/rx_2/rx_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log synthTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source synthTop.tcl
