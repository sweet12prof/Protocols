...
HD_PWD='C:/Users/Chris Nutsukpui/rx_2/rx_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log synthTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source synthTop.tcl -notrace
